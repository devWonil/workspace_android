...
import com.example.movie_1_ex.adapter.MovieAdapter;
import com.example.movie_1_ex.databinding.FragmentMovieBinding;
import com.example.movie_1_ex.interfaces.OnChangeToolbarType;
import com.example.movie_1_ex.interfaces.OnMovieitemClicked;
import com.example.movie_1_ex.models.Movie;
import com.example.movie_1_ex.models.YtsData;
import com.example.movie_1_ex.repository.MovieService;
...
public class MovieFragment extends Fragment implements OnMovieitemClicked {
    ...
    public MovieFragment(OnChangeToolbarType onChangeToolbarType) {
    ...
    public static MovieFragment getInstance(OnChangeToolbarType onChangeToolbarType) {
        // 메소드 (static 통해서 new MovieFragment())
...
//        inflater.inflate(R.layout.fragment_movie, container, false);
        ...
        // null pointer exception 이기 때문에 주소를 연결해준다
        // 누가 내 메소드를 연결받을지 연결
                ...
                .enqueue(new Callback<YtsData>() {
                    ...
                    public void onResponse(Call<YtsData> call, Response<YtsData> response) {
                        if (response.isSuccessful()){
                            // 통신을 통해서 데이터를 넘겨받았으면 adapter에 데이터를 전달해서 화면을 갱신
