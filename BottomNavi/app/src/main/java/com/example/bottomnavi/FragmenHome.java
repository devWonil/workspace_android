 ...
 * Use the {@link FragmenHome#newInstance} factory method to
...
public class FragmenHome extends Fragment {
    ...
    public static FragmenHome newInstance(String param1, String param2) {
        FragmenHome fragment = new FragmenHome();
